...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Informa el pais del atleta que fue pasado por parametro
	 * 
	 * @param nombre  El nombre del atleta a buscar. (str)
	 * @return Un String del pais del atleta pasado por parametro. 
	*/
