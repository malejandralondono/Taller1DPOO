...
public class ConsolaOlimpicos
{
	...
	private void ejecutarNacionalidadAtleta()
	{
		...
		String nombrePais = calculadora.nacionalidadAtleta(nombre);
		
		if (!nombrePais.equals(null))
			{
			System.out.println("La nacionalidad del atleta es: " + nombrePais);
			}
		else
			{
			System.out.println("No fue posible encontrar la nacionalidad del atleta ingresado.");
			}
	}
